...
# Exercise-2 TODOs:
    ...
    outlier_filtered = cloud_filtered
...
# Exercise-3 TODOs:
    ...
    for index, pts_list in enumerate(cluster_indices):
        ...
        chists = compute_color_histograms(ros_cluster, bins=bins, using_hsv=True)
...
def pr2_mover(object_list):
    ...
    for item in object_list_param:
        object_groups[item['name']] = item['group']
	...
	group = object_groups[object.label]
        ...
        for value in centroid:
            pose_vector.append(np.asscalar(value))
        pick_pose = Pose()
        pick_pose.position.x = pose_vector[0]
        pick_pose.position.y = pose_vector[1]
        pick_pose.position.z = pose_vector[2]
        
        # Create 'place_pose' for the object
        place_pose = Pose()
        place_vector = dropbox_dict[arm_name.data]
        place_pose.position.x = place_vector[0]
        place_pose.position.y = place_vector[1]
        place_pose.position.z = place_vector[2]             
        
        #  Create a list of dictionaries (made with make_yaml_dict()) for later output to yaml format
        dict_list.append(make_yaml_dict(test_num, arm_name, object_name, pick_pose, place_pose))
    ...
    filename = 'output_' + test_num.data + '.yaml'
